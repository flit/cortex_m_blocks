...
void * _NSConcreteStackBlock[1] = { 0 };
void * _NSConcreteMallocBlock[1] = { 0 };
void * _NSConcreteAutoBlock[1] = { 0 };
void * _NSConcreteFinalizingBlock[1] = { 0 };
void * _NSConcreteGlobalBlock[1] = { 0 };
void * _NSConcreteWeakBlockVariable[1] = { 0 };
